...
class TestFuzzyMatching(unittest.TestCase):
    ...
    def test_fuzzy_matching(self):
        ...
        scraper_data = [
            ...
            Row(product_id=40.0, marketplace_name="olx", product_name="apple macbook 12", brand="apple", category="laptop", condition="new", resale_price=800.0, seller_name="sellerd", seller_rating=4.2, location="india", listing_date="2024-01-01", product_url="http://test4", availability_status="available", scraped_date="2024-01-02", model_code="macbook 12"),
        ]
